...
const ProfileEdit = () => {
	...
	const handleUpdate = async () => {
		...
		const docRef = doc(db, "advertiser_database", user.uid);
	...
	return (
		<>
			...
			<div className='hidden lg:block left-position absolute top-24 mt-2 px-10 py-6 Nunito w-10/12 bg-white z-20'>
				<div className='flex items-center cursor-pointer mt-7' onClick={() => { router.back() }}><MdKeyboardArrowLeft className='mr-1 text-3xl' />Back</div>
